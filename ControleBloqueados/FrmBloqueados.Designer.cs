namespace ControleBloqueados
{
    partial class frmBloqueados
    {
        ...
        private void InitializeComponent()
        {
			...
			this.dtgCadastrosBloqueados.CellContentDoubleClick += new System.Windows.Forms.DataGridViewCellEventHandler(this.dtgCadastrosBloqueados_CellContentDoubleClick);
			// 
			// txtNomeCliente
			// 
